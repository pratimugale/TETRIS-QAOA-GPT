...
class FeatherGraph(Estimator):
    ...
    def fit(self, graphs: List[nx.classes.graph.Graph], show_progress=False) -> None:
        """
        ...
        self._embedding = [
            self._calculate_feather(graph) for graph in tqdm(graphs, desc='Calculating FEATHER', disable=not show_progress)
        ]
