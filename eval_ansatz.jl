...
function eval_ansatz(
    ...
    # We use qaoa_mixer as the standard pool for Max-3-SAT (Deterministic X_{1:N} order)
    ...
    # formula_data is expected to be a Vector{Vector{Dict}} (list of clauses)
    ...
    for layer_ops in op_indices
        ...
        for op_idx in idxs
            ...
            # Parallel bit: push only the mixer. bind! will set angles later.
